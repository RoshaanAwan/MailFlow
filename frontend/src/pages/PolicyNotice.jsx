    ...
    <div style={{ minHeight: "100vh", background: "#0f0f0f", color: "#f0f0f0" }}>
      <div style={s.wrap}>
        ...
        <section style={s.section}>
          ...
          <p style={s.p}>
            MailFlow's use and transfer to any other app of information received from Google APIs will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" rel="noopener noreferrer" style={{color: "#f0f0f0"}}>Google API Services User Data Policy</a>, including the Limited Use requirements.
          </p>
          <p style={s.p}>
